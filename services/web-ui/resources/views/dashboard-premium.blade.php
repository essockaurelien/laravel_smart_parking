    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body {
            ...
            color: var(--ink);
            background:
                radial-gradient(circle at 10% 25%, #fde68a55, transparent 55%),
                radial-gradient(circle at 85% 10%, #99f6e455, transparent 50%),
                var(--cream);
            min-height: 100vh;
        }
        header {
        ...
        .status { font-weight: 700; color: var(--teal); }
        .error { color: var(--rose); font-weight: 600; }
        table { width: 100%; border-collapse: collapse; margin-top: 8px; }
        th, td { border: 1px solid var(--ink); padding: 6px; text-align: left; }
        .tag { display: inline-block; padding: 4px 8px; border: 2px solid var(--ink); background: #e0f2fe; font-weight: 700; }
...
<body>
    <header>
        <div>
            <h1>sPark Premium</h1>
            <div class="note">Benvenuto, {{ $user['name'] ?? 'Automobilista' }} <span class="tag">Premium</span></div>
        </div>
    ...
    <main>
        ...
        <div class="grid">
            <div class="card">
                ...
                <form method="POST" action="/reservations">
                    ...
                    <input type="text" name="card_number" inputmode="numeric" required>
                    <label>Intestatario</label>
                    <input type="text" name="card_holder" required>
                    <label>Mese scadenza</label>
                    <input type="number" name="card_exp_month" min="1" max="12" required>
                    <label>Anno scadenza</label>
                    <input type="number" name="card_exp_year" min="2020" required>
                    <button type="submit">Prenota Posto</button>
                </form>
                <p class="note">La prenotazione scade se arrivi oltre la tolleranza.</p>
            </div>
        ...
        <div class="card">
            ...
            @else
                <p class="note">Nessuna prenotazione trovata.</p>
            @endif
        </div>
